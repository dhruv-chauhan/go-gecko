...
[![Build Status](https://travis-ci.com/dhruv-chauhan/go-gecko.svg?branch=master)](https://travis-ci.com/dhruv-chauhan/go-gecko) [![GoDoc](https://godoc.org/github.com/dhruv-chauhan/go-gecko?status.svg)](https://godoc.org/github.com/dhruv-chauhan/go-gecko)
...
```
go get -u github.com/dhruv-chauhan/go-gecko
```
...
import (
	...
	coingecko "github.com/dhruv-chauhan/go-gecko/v3"
)
